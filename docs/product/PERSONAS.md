...
## 2. O Emissor de RWA: "Ricardo, Gestor de Frota"
- **Perfil:** Empresário que possui 50 máquinas agrícolas e precisa de capital de giro para expandir.
- **Jornada:**
    1. Ricardo cria um **Machine-Health SBT** para cada trator.
    2. Ele vincula os dados de telemetria IoT ao Spoke RWA do Zolvency.
    3. Investidores on-chain veem que a frota está operando a 95% de eficiência.
    4. Ricardo usa o SBT como colateral para um empréstimo de $500k na Stellar com LTV dinâmico.

## 3. O Parceiro de Ecossistema: "LendProtocol (EVM)"
