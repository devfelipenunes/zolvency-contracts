...
4. **MANDATO DE SINCRONIZAÇÃO E DENSIDADE:** É obrigatório atualizar os documentos correspondentes (`ARCHITECTURE.md`, `ZTS_01_STANDARD.md`, `RWA_LIFECYCLE.md`, `ZK_EMAIL_FLOW.md`) sempre que houver mudanças técnicas. A documentação DEVE seguir o **Protocolo de Hiper-Densidade**: incluir teoria pura, detalhes de implementação, crítica de engenharia e análise de red teaming. Nunca aceite documentação rasa; busque profundidade técnica máxima focada nos contratos.
