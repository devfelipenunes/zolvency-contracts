...
pub use types::{
    ...
    RenewalWindow, TokenMetadata, UpdateParams, Ecosystem,
};
...
impl ZolvencyTokenTrait for BinanceKycContract {
    ...
    fn get_metadata(env: Env) -> TokenMetadata {
        TokenMetadata {
            name: String::from_str(&env, "Zolvency Stamp"),
            symbol: String::from_str(&env, "ZOLV-STAMP"),
            version: String::from_str(&env, "1.0.0"),
            data_source: String::from_str(&env, "reclaim zk-tls"),
        }
    }
...
impl BinanceKycContract {
    ...
    pub fn mint(
        ...
        let proof_data = if config.store_proof_data {
            params.proof_data
        } else {
    ...
    pub fn update_token(
        ...
        data.kyc_level = params.kyc_level.clone();
