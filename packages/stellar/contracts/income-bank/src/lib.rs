...
pub use types::{
    CrossChainParams, Error, IncomeData, InteropConfig, InteropProtocol, MintParams, RenewalWindow,
...
impl ZolvencyTokenTrait for IncomeBankContract {
    ...
    fn get_metadata(env: Env) -> TokenMetadata {
        TokenMetadata {
            name: String::from_str(&env, "Zolvency Bank Income"),
            symbol: String::from_str(&env, "ZOLV-BANK"),
            version: String::from_str(&env, "1.0.0"),
            data_source: String::from_str(&env, "zk-email"),
        }
    }
