...
SOUL_WASM="target/wasm32-unknown-unknown/release/zolvency_soul.wasm"
...
GITHUB_WASM="target/wasm32-unknown-unknown/release/github_identity.wasm"
...
UBER_WASM="target/wasm32-unknown-unknown/release/uber_income.wasm"
